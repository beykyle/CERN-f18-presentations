...
\begin{document}
    ...
    \frame{
      \frametitle{3 Point Gain}
      Measures gain \& noise at 3 power supply currents
				\begin{figure}
					\includegraphics[trim={0cm 0cm 0cm 0cm},clip,width=0.5\textwidth]{p1-figs/3pg1.png}
				\end{figure}
    ...
    \frame{
      ...
      Measures gain \& noise at 3 power supply currents
				\begin{figure}
					\includegraphics[trim={0cm 0cm 0cm 0cm},clip,width=0.5\textwidth]{p1-figs/3pg2.png}
				\end{figure}

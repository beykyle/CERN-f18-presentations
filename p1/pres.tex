...
\begin{document}
    ...
    \frame{
      ...
      \begin{block}{Progress}
        \begin{itemize}
            \item Preliminary tests with ITSDAQ software
      ...
      \begin{block}{Obstacles}
        \begin{itemize}
            ...
            \item NI-VISA instrument control software doesn't recognize our power supplies
        \end{itemize}
      \end{block}
    }
    ...
    \frame{
      ...
      \begin{block}{}
        \begin{itemize}
            \item Get ITSDAQ working 
            \item Solve NI-VISA issues and run HV controller through ITSDAQ
